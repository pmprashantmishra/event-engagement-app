        ...
        E = h(function (t, r) {
            ...
            (r.isValid = function (t) {
                ...
                (r.getBestMask = function (t, e) {
                    for (
                        var n = Object.keys(r.Patterns).length,
                            o = 0,
                            a = 1 / 0,
                            i = 0;
                        i < n;
            ...
            (r.getBestVersionForData = function (t, e) {
                ...
                if (Array.isArray(t)) {
                    if (t.length > 1)
                        return (function (t, e) {
                            for (var n = 1; n <= 40; n++) {
                                if (o(t, n) <= r.getCapacity(n, e, K.MIXED))
                                    return n;
                            }
                        })(t, a);
                ...
                (r.fromString = function (t, n) {
                    ...
                    return r.fromArray(
                        (function (t) {
                            return t.reduce(function (t, r) {
                                var e =
                                    t.length - 1 >= 0 ? t[t.length - 1] : null;
